        ...
        <nav class="fixed w-full z-50 transition-all duration-300 bg-white border-b border-gray-200 shadow-sm" id="navbar">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-20">
                    ...
                    <div class="hidden md:flex space-x-6 lg:space-x-8 items-center">
                        <a href="index.html" class="${isBeranda ? activeClassDesk : inactiveClassDesk}">Home</a>
                        <a href="katalog.html" class="${isKatalog ? activeClassDesk : inactiveClassDesk}">Catalog</a>
                        <a href="proyek.html" class="${isProyek ? activeClassDesk : inactiveClassDesk}">Projects</a>
                        <a href="artikel.html" class="${path.includes('artikel') ? activeClassDesk : inactiveClassDesk}">Journal</a>
                        <a href="tentang.html" class="${isTentang ? activeClassDesk : inactiveClassDesk}">About Us</a>
                        <div class="h-6 w-px bg-gray-300 mx-2"></div>
                        <a href="../index.html" class="text-slate-400 hover:text-slate-900 font-bold text-sm transition-colors">ID</a>
                        <span class="text-gray-300">|</span>
                        <a href="index.html" class="text-brand-accent font-black text-sm">EN</a>
                    ...
                    <div class="md:hidden flex items-center gap-4">
                        <div class="flex items-center gap-2 text-xs font-bold">
                            <a href="../index.html" class="text-slate-400">ID</a> <span class="text-gray-300">|</span> <a href="index.html" class="text-brand-accent">EN</a>
                        </div>
            ...
            <div id="mobile-menu" class="hidden md:hidden bg-white border-b border-gray-200 absolute w-full shadow-lg max-h-[80vh] overflow-y-auto">
                <div class="px-0 pt-2 pb-4 space-y-1">
                    <a href="index.html" class="${isBeranda ? activeClassMob : inactiveClassMob}">Home</a>
                    <a href="katalog.html" class="${isKatalog ? activeClassMob : inactiveClassMob}">Catalog</a>
                    <a href="proyek.html" class="${isProyek ? activeClassMob : inactiveClassMob}">Projects</a>
                    <a href="artikel.html" class="${path.includes('artikel') ? activeClassMob : inactiveClassMob}">Journal</a>
                    <a href="tentang.html" class="${isTentang ? activeClassMob : inactiveClassMob}">About Us</a>
                    <div class="px-4 mt-4">
                        <a href="kontak.html" class="wa-global-btn block w-full text-center px-4 py-3 text-base font-bold text-white bg-slate-900 rounded-sm shadow-sm uppercase tracking-wide">Get Quotation</a>
                    </div>
                </div>
            </div>
        </nav>
                ...
                <div class="grid md:grid-cols-3 gap-12 mb-12">
                    <div>
                        ...
                        <p class="text-slate-400 text-sm leading-relaxed mb-6 font-medium pr-4">
                            Fabrication and installation of custom iron construction for exclusive residential and commercial properties. Committed to ultimate geometric precision.
                        </p>
                    </div>
                    <div>
                        <h4 class="text-white font-black mb-6 uppercase tracking-widest text-sm">Quick Links</h4>
